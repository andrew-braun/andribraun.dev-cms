...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_technologies_category" AS ENUM('backend', 'cms', 'database', 'design', 'devops', 'framework', 'frontend', 'language', 'tool');
  ...
  CREATE TABLE "technologies_category" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_technologies_category",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  ALTER TABLE "technologies_category" ADD CONSTRAINT "technologies_category_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."technologies"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "projects_rels_media_id_idx" ON "projects_rels" USING btree ("media_id","path");
  CREATE INDEX "technologies_category_order_idx" ON "technologies_category" USING btree ("order");
  CREATE INDEX "technologies_category_parent_idx" ON "technologies_category" USING btree ("parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "technologies_category" CASCADE;
